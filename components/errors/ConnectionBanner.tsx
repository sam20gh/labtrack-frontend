 ...
 *    copy says "Can't reach LabTrack" rather than "You're offline" for that reason — one is
...
const ConnectionBanner = ({ onRetry }: Props) => {
    ...
    useEffect(() => {
        ...
        if (offline) AccessibilityInfo.announceForAccessibility("Can't reach LabTrack. You may be offline.");
    }, [offline, slide]);
    ...
    return (
        ...
        >
            <Pressable
                ...
                accessibilityLabel={
                    onRetry ? "Can't reach LabTrack. Tap to retry." : "Can't reach LabTrack. You may be offline."
                }
            >
                <Ionicons name="wifi-outline" size={14} color={Palette.alert} />
                <Text style={styles.label}>Can&apos;t reach LabTrack</Text>
