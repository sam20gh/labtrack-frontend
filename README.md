...
React Native 0.76 + Expo SDK 52 client for Predyqt. File-based routing via
...
read `docs/KNOWN-ISSUES.md` in the Predyqt workspace before adding or renaming a step.
...
These live in the Predyqt workspace directory that contains this repo, not in this repo
itself:
