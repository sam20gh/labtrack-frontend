...
export default function SourcesScreen() {
    ...
    const confirmDisconnect = (id: string, label: string) => {
        Alert.alert(
            `Disconnect ${label}?`,
            'Predyqt will stop reading new data. Everything already imported stays in your history.',
            [
            ...
            {loading ? (
                ...
                <ScrollView contentContainerStyle={styles.content}>
                    <Text style={styles.intro}>
                        Predyqt reads workouts, sleep and heart rate from {label}. Anything your
