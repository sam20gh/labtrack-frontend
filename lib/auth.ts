 ...
 *   2. Legacy tokens issued by the Predyqt API and stored in AsyncStorage under
 ...
 * owns the credential, but medical records hang off a Predyqt `User` document, and
...
export const STORAGE_KEYS = {
    userId: 'userId',
    /** Legacy Predyqt-issued JWT. Absent for Supabase-only accounts. */
...
/** The signed-in Predyqt user id, or null. */
...
/**
 * Create or link the Predyqt account behind the current Supabase identity and cache its
